                ...
                <section>
                    <div className="container">
                        <div className="services__wrapper">
                            <h1 className="services__h1">Предоставляю услуги консалтингового агентства "Ресурс"</h1>
                                    ...
                                    <div className={`accordion-item ${item1Visible ? "accordion__animation" : ""}`} >
                                        ...
                                        </div>
                                        {
                                            ...
                                            >
                                                <span>
                                                    <i>
                                                        Проведение индивидуальной фокус группы и формируем план
                                                    </i>
                                                </span>
                                                <ul className="list">
                                            ...
                                            &&
                                                ...
                                                >
                                                    ...
                                                    <ul className="list">
                                                        ...
                                                        <li>—   Оформленные и прописанные правила внутреннего трудового распорядка компании, правида взаимодействия и подход к работе</li>
                                        ...
                                        </div>
                                        {
                                            ...
                                            >
                                                ...
                                                <ul className="list">
                                                    ...
                                                    <li>—   Комуникации</li>
                                                    <li>—   Видите слабые и сильные стороны команды</li>
