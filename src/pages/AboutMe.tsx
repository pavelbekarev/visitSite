                        ...
                        <div className="aboutMe__wrapper">
                            <div className="upper__content">
                                ...
                                <ul className="upper__text">
                                    ...
                                    <li>Занималась подбором и построением команды, оргструктурой компании. Внедрила адаптацию и наставническую программу. И всё это привело меня к основам управления персоналом. Можно сколько угодно подбирать и обучать кадры если нет здравого управления командой.</li>
                            ...
                            <div className="bottom__content">
                                ...
                                <span className="bottom__text">
                                    ...
                                    Найти решение для развития и масштабирования проектов обеспечивающие развитие человеческого ресурса.
                                </span>
                            </div>
                        </div>
